...
'''
    ...
    environment {
        ...
        MANIFEST_DEV_PATH_FE  = "${APP_NAME}/dev/frontend-deployment.yaml"
        MANIFEST_DEV_PATH_BE  = "${APP_NAME}/dev/backend-deployment.yaml"
        MANIFEST_PROD_PATH_FE = "${APP_NAME}/prod/frontend-deployment.yaml"
        MANIFEST_PROD_PATH_BE = "${APP_NAME}/prod/backend-deployment.yaml"
    }
